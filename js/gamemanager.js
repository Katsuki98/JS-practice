let GameManager = {
    ...
    resetPlayer: function(classType) {
        ...
        getInterface.innerHTML = '<img src="img/Katsuki.jpg" class="img-avatar">'
            + '<div><h3>' + classType + '</h3><p class="health-player">Health: ' + player.health + '</p><p>Mana: '
    ...
    setFight: function() {
        ...
        getEnemy.innerHTML = '<img src="img/Katsuki.jpg">'
            + '<div><h3>' + enemy.enemyType + '</h3><p class="health-enemy">Health: ' + enemy.health + '</p><p>Mana: '
